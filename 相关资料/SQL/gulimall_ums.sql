...
MySQL - 5.7.31 : Database - gulimall_ums
*********************************************************************
*/
...
CREATE TABLE `ums_member` (
  ...
  `expires_in` varchar(255) DEFAULT NULL COMMENT '访问令牌',
  `access_token` varchar(255) DEFAULT NULL COMMENT '访问令牌过期时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COMMENT='会员';

/*Data for the table `ums_member` */

insert  into `ums_member`(`id`,`level_id`,`username`,`password`,`nickname`,`mobile`,`email`,`header`,`gender`,`birth`,`city`,`job`,`sign`,`source_type`,`integration`,`growth`,`status`,`create_time`,`social_uid`,`expires_in`,`access_token`) values (2,1,'pengcheng','$2a$10$Zfsts0PIG5FRwealOtG79u4lakttjJUgJm.AvPZhFPoQy1Bs0eSwq','123','13045929247',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,1,'mengqi','$2a$10$Tm/sBi2pVuQWnOX671hK5.nsUNOWXKGIbGLFtCzcc1taHcNgfHVCe','123','13229298601',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(16,NULL,NULL,NULL,'for_sum_',NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'6048169178','157679999','2.00mFV_bG4wwiOBa9bbd37186gmCHUD'),(17,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'5266118854','145568','2.00sEG5kF4wwiOB78dce63583LdL5ID'),(18,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'7484002650','148140','2.00KyGUKI4wwiOB6b9d219b4d0YS_XD'),(20,1,'for_sum','$2a$10$Vus5iJBcDFez8xuXrS9cCuDfN/UXePaaqNZgFMwCZ8YRF2RHqo.8C','for_sum','13112716808',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `ums_member_receive_address` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='会员收货地址';

/*Data for the table `ums_member_receive_address` */

insert  into `ums_member_receive_address`(`id`,`member_id`,`name`,`phone`,`post_code`,`province`,`city`,`region`,`detail_address`,`areacode`,`default_status`) values (1,20,'张三','13112716808','25844','广东省','佛山','南海区','佛山大道','9527',1),(2,20,'郭承乾','13112716808','25844','上海市','上海市','松江区','大江大厦','9527',0),(3,16,'郭承乾','13112716808','25844','上海市','上海市','松江区','大江大厦','9527',0);
