...
MySQL - 5.7.31 : Database - gulimall_sms
*********************************************************************
*/
...
insert  into `sms_seckill_session`(`id`,`name`,`start_time`,`end_time`,`status`,`create_time`) values (1,'8:00','2020-08-11 13:00:00','2020-08-11 21:00:00',1,'2020-08-09 07:52:37'),(2,'9:00','2020-08-11 13:00:00','2020-08-11 20:00:00',1,'2020-08-09 07:53:21'),(3,'14:00','2020-08-11 13:00:00','2020-08-11 22:00:00',1,'2020-08-10 04:41:22');
...
insert  into `sms_seckill_sku_relation`(`id`,`promotion_id`,`promotion_session_id`,`sku_id`,`seckill_price`,`seckill_count`,`seckill_limit`,`seckill_sort`) values (1,NULL,1,1,'1','8','1',1),(2,NULL,2,2,'2','8','1',1),(3,NULL,3,3,'3','8','1',1),(4,NULL,NULL,4,NULL,'3','1',1);
...
insert  into `sms_sku_full_reduction`(`id`,`sku_id`,`full_price`,`reduce_price`,`add_other`) values (1,1,'10000.0000','20.0000',NULL);
...
insert  into `sms_sku_ladder`(`id`,`sku_id`,`full_count`,`discount`,`price`,`add_other`) values (1,1,3,'0.98',NULL,1);
...
insert  into `sms_spu_bounds`(`id`,`spu_id`,`grow_bounds`,`buy_bounds`,`work`) values (1,5,'500.0000','500.0000',NULL),(2,6,'500.0000','500.0000',NULL),(3,7,'500.0000','500.0000',NULL),(4,8,'500.0000','500.0000',NULL),(5,9,'100.0000','500.0000',NULL),(6,10,'100.0000','500.0000',NULL),(7,11,'100.0000','500.0000',NULL),(8,12,'100.0000','100.0000',NULL),(9,13,'100.0000','100.0000',NULL),(10,14,'4.0000','5.0000',NULL),(11,15,'4.0000','5.0000',NULL);
