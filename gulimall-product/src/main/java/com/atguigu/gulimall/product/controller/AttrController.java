...
public class AttrController {
    ...
    public R baseAttrList(@RequestParam Map<String, Object> param,
                          @PathVariable("catelogId") long catelogId,
                          @PathVariable("attrType") String type ) throws Exception {
        PageUtils page = attrService.queryBaseAttrPage(param,catelogId,type);
        return R.ok().put("page",page);
    }

    ///product/attr/base/listforspu/{spuId}
    @GetMapping("/base/listforspu/{spuId}")
    public R baseAttrlistforpu(@PathVariable("spuId") long spuId) {
